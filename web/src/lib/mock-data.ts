...
export const templatesCatalog = [
  { id: "tmp-01", name: "Proposition de services", module: "CRM", status: "Enrichi" },
  { id: "tmp-02", name: "Devis", module: "CRM / Finance", status: "Enrichi" },
  { id: "tmp-03", name: "Bon de commande", module: "Commercial / Ops", status: "Enrichi" },
  { id: "tmp-04", name: "Bon de livraison", module: "Ops / Logistique", status: "Enrichi" },
  { id: "tmp-05", name: "Contrat de prestation", module: "CRM / Juridique", status: "Enrichi" },
  { id: "tmp-06", name: "Avenant au contrat", module: "CRM / Direction", status: "Enrichi" },
  { id: "tmp-07", name: "Contrat agent", module: "RH", status: "Enrichi" },
  { id: "tmp-08", name: "Fiche de poste", module: "RH", status: "Enrichi" },
  { id: "tmp-09", name: "Dossier d’embauche", module: "RH", status: "Enrichi" },
  { id: "tmp-10", name: "Entretien candidat", module: "RH", status: "Enrichi" },
  { id: "tmp-11", name: "Onboarding", module: "RH / Ops", status: "Enrichi" },
  { id: "tmp-12", name: "Ordre de travail", module: "Opérations", status: "Enrichi" },
  { id: "tmp-13", name: "Contrôle qualité", module: "Qualité", status: "Enrichi" },
  { id: "tmp-14", name: "Rapport de prestation", module: "Ops / Qualité", status: "Enrichi" },
  { id: "tmp-15", name: "Demande d’achat", module: "Ops / Achats", status: "Enrichi" },
  { id: "tmp-16", name: "Demande de congé", module: "RH", status: "Enrichi" },
  { id: "tmp-17", name: "Fiche de pointage", module: "Ops / RH", status: "Enrichi" },
  { id: "tmp-18", name: "Préfacture", module: "Finance", status: "Enrichi" },
  { id: "tmp-19", name: "Facture", module: "Finance", status: "Enrichi" },
  { id: "tmp-20", name: "Avoir", module: "Finance", status: "Enrichi" },
  { id: "tmp-21", name: "Relevé de compte", module: "Finance", status: "Enrichi" },
  { id: "tmp-22", name: "Relance client", module: "Recouvrement", status: "Enrichi" },
  { id: "tmp-23", name: "Accusé de réception", module: "Admin", status: "Enrichi" },
  { id: "tmp-24", name: "Rapport mensuel", module: "Direction / BI", status: "Enrichi" },
  { id: "tmp-25", name: "Visite technique", module: "CRM / Ops", status: "Enrichi" },
];
