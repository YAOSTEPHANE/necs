...
export const DOCUMENTS: DocumentDef[] = [
  {
    ...
    refPrefix: "NECS-OFF",
    subtitle:
      "Offre complète : besoin, méthodologie, moyens, chiffrage mensuel et acceptation.",
    note: "Module app : /admin/commercial — opportunité → visite (TMP-25) → offre → devis (TMP-02) → BC (TMP-03).",
    domain: "CRM",
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { name: "opp_ref", label: "Réf. opportunité", kind: "text", hint: "OPP-2026-…" },
        ],
      },
      {
        title: "Périmètre",
        fields: [
          {
            ...
            required: true,
            full: true,
            defaultValue: "Proposition de services de nettoyage professionnel",
          },
          {
            name: "type_locaux",
            ...
            kind: "select",
            required: true,
            options: ["Bureaux", "Industrie", "Commerce", "Résidentiel", "Santé", "Autre"],
          },
          ...
          {
            name: "methodo",
            label: "Notes méthodologie (complément)",
            kind: "textarea",
            full: true,
          },
          {
            name: "equipe",
            label: "Composition équipe (détail)",
            kind: "textarea",
            full: true,
          },
        ],
    ...
    checks: [],
    lineHeaders: ["Prestation", "Fréquence", "Effectif", "Montant HT / mois"],
    lineRows: [
    ...
    records: [
      {
        id: "OFF-0001",
        label: "Société Exemple SA ; Bureaux Premium",
        status: "Brouillon",
        owner: "A. Mbarga",
        updated: "10/09/2026",
        amount: "897 000 FCFA / mois",
      },
      {
        id: "OFF-0002",
        label: "Mall Riviera ; Premium",
        status: "Envoyée",
        owner: "P. Ngo",
        updated: "08/09/2026",
        amount: "2,1 M FCFA / mois",
      },
    ],
  },
  {
    ...
    refPrefix: "NECS-DEV",
    subtitle:
      "Chiffrage détaillé : lignes, quantités, PU, remise, TVA et bon pour accord.",
    note: "Module app : /admin/commercial?tab=chiffrage — chaîne besoin → visite → chiffrage (versions/seuils) → offre → BC.",
    domain: "CRM",
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: "Devise",
            kind: "select",
            options: ["FCFA (XAF)", "EUR", "USD"],
            defaultValue: "FCFA (XAF)",
          },
          {
            name: "paiement",
            label: "Conditions de paiement",
            kind: "select",
            options: ["30 jours net", "45 jours", "Comptant", "Échéancier"],
            defaultValue: "30 jours net",
          },
          {
            name: "notes",
            label: "Notes / conditions complémentaires",
            kind: "textarea",
            full: true,
          },
        ],
    ...
    checks: [],
    lineHeaders: ["Désignation", "Qté", "Unité", "P.U. HT", "Période", "Total HT"],
    lineRows: [
      [
  ...
  },
  {
    ...
    note: "Module app : /admin/commercial?tab=bons-commande (aussi Ops) — devis (TMP-02) → BC → contrat (TMP-05) → OPS.",
    domain: "CRM",
  ...
  },
  {
    ...
    note: "Chaîne logistique : DA (TMP-15) → BL → stock / site.",
    domain: "OPS",
  ...
  },
  {
    ...
    module: "Direction / Juridique",
    file: "TMP-05-contrat-prestation.html",
    docType: "Contrat client",
    refPrefix: "NECS-CTR",
    subtitle: "Parties, périmètre, SLA, prix, durée et signatures.",
    note: "Module app : /admin/direction?tab=contrat (aussi /admin/juridique) — BC (TMP-03) → contrat → avenant (TMP-06).",
    domain: "CRM",
  ...
  },
  {
    ...
    module: "Direction / CRM",
    file: "TMP-06-avenant-contrat.html",
    docType: "Avenant",
    refPrefix: "NECS-AVN",
    subtitle: "Modification de périmètre, tarif, durée ou effectifs.",
    note: "Module app : /admin/direction?tab=avenants (aussi /admin/commercial?tab=avenants) — modifie TMP-05.",
    domain: "CRM",
  ...
  },
  {
    ...
    note: "Chaîne RH : entretien → dossier (TMP-09) → contrat agent → onboarding.",
    domain: "RH",
  ...
  },
  {
    ...
    note: "Référentiel RH ; liée aux contrats agents et aux recrutements.",
    domain: "RH",
  ...
  },
  {
    ...
    note: "Chaîne RH : entretien (TMP-10) → dossier → contrat (TMP-07).",
    domain: "RH",
  ...
  },
  {
    ...
    note: "Chaîne RH : entretien → dossier (TMP-09) → contrat (TMP-07).",
    domain: "RH",
  ...
  },
  {
    ...
    note: "Suite du contrat agent (TMP-07) jusqu’à validation terrain.",
    domain: "RH",
  ...
  },
  {
    ...
    note: "Exécution terrain : planning → OT → preuves → clôture superviseur.",
    domain: "OPS",
  ...
  },
  {
    ...
    note: "Qualité terrain : scores, NC, photos et actions correctives.",
    domain: "Q",
  ...
  },
  {
    ...
    note: "Synthèse période ; alimente préfacture (TMP-18) et restitution client.",
    domain: "OPS",
  ...
  },
  {
    ...
    note: "Achats : DA → validation N+1 → BL (TMP-04).",
    domain: "OPS",
  ...
  },
  {
    ...
    note: "Impact planning RH / OPS ; solde et remplaçant obligatoires.",
    domain: "RH",
  ...
  },
  {
    ...
    note: "Présences terrain ; clôture chef d’équipe ; lien paie / RH.",
    domain: "OPS",
  ...
  },
  {
    ...
    note: "Module app : /admin/finance?tab=prefactures — rapport / OT → préfacture → facture (TMP-19).",
    domain: "FIN",
  ...
  },
  {
    ...
    note: "Chaîne finance : préfacture (TMP-18) → facture → relance (TMP-22).",
    domain: "FIN",
  ...
  },
  {
    ...
    note: "Corrige une facture (TMP-19) ; motif et validation Finance.",
    domain: "FIN",
  ...
  },
  {
    ...
    note: "Synthèse débits / crédits ; alimente relances si solde dû.",
    domain: "FIN",
  ...
  },
  {
    ...
    note: "Module app : /admin/finance?tab=relances — recouvrement amiable → escalade ; lié factures en retard.",
    domain: "FIN",
  ...
  },
  {
    ...
    note: "Module app : /admin/commercial?tab=acks (aussi Finance) — preuve de transmission avec pièces.",
    domain: "CRM",
  ...
  },
  {
    ...
    note: "Module app : /admin/direction?tab=rapport — KPI multi-sites ; validation Direction ; restitution client.",
    domain: "BI",
  ...
  },
  {
    ...
    note: "Module app : /admin/commercial?tab=audit-visite (aussi Qualité) — visite → offre (TMP-01) / devis (TMP-02).",
    domain: "CRM",
  ...
  },
  {
    ...
    module: "RH / Paie",
    file: "TMP-26-bulletin-paie.html",
    docType: "Paie",
    refPrefix: "NECS-RH-PAIE",
    subtitle: "Gains, CNPS, IRPP et net à payer collaborateur (FCFA).",
    note: "Module app : /admin/paie (aussi RH → Paie) — pointage (TMP-17) → bulletin mensuel.",
    domain: "RH",
    htmlPath: "/galerie/templates/TMP-26-bulletin-paie.html",
    sections: [
      {
        title: "Collaborateur",
        fields: [
          { name: "nom", label: "Nom & prénoms", kind: "text", required: true },
          { name: "matricule", label: "Matricule", kind: "text" },
          { name: "cnps", label: "N° CNPS salarié", kind: "text" },
          { name: "poste", label: "Poste", kind: "text", defaultValue: "Agent d’entretien" },
          { name: "site", label: "Site d’affectation", kind: "text" },
          { name: "periode", label: "Période", kind: "month", required: true },
          {
            ...
            kind: "select",
            options: ["Virement bancaire", "Mobile Money", "Espèces", "Chèque"],
      ...
      {
        title: "Éléments de rémunération (FCFA)",
        fields: [
          { name: "base", label: "Salaire de base", kind: "number", required: true },
          { name: "transport", label: "Indemnité de transport", kind: "number", defaultValue: "25000" },
          { name: "primes", label: "Primes", kind: "number", defaultValue: "0" },
          { name: "hs_h", label: "Heures supplémentaires (h)", kind: "number", defaultValue: "0" },
          { name: "hs_mt", label: "Montant heures supp.", kind: "number" },
          { name: "autres_gains", label: "Autres gains", kind: "number", defaultValue: "0" },
          { name: "autres_retenues", label: "Autres retenues", kind: "number", defaultValue: "0" },
        ],
      },
    ],
    checks: [],
    ...
    lineRows: [
      ...
      ["PRIME", "Primes", "10 000", "—"],
      ["HS", "Heures supplémentaires", "4 327", "—"],
  ...
  },
  {
    ...
    note: "Lead web → qualification CRM → visite (DIG-03) ou devis.",
    domain: "DIG",
  ...
  },
  {
    ...
    note: "Messages site ; SLA, affectation métier et escalade.",
    domain: "DIG",
  ...
  },
  {
    ...
    note: "Planifie une VT ; alimente TMP-25 puis offre / devis.",
    domain: "DIG",
